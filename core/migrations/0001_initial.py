# Generated by Django 5.0 on 2024-02-10 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('En attente', 'En attente'), ('Livré', 'Livré')], default='En attente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_produit', models.CharField(choices=[('FLEUR', 'Fleur'), ('BOUQUET', 'Bouquet'), ('PARFUM', 'Parfum')], default='FLEUR', max_length=255)),
