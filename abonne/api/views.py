...
from core.api.serializers import UtilisateurSerializer,AbonneSerializer,CommandeSerializer,LigneCommandeSerializer
...
def lister_commandes_abonne(request):
    try:
        ...
        commandes_abonne = Commande.objects.filter(id_commandant=user, statut__ne='livré')
